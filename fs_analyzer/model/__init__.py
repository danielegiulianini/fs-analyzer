...
* file_categorization_strategy.py: containing some interchangeable strategies for 
    ...
    (OO) design pattern.
* file_category: containing the definition of the class representing the abstraction
    of file category.
* file_listing_generators: containing many reusable and performant generators of
    information like size, category and permissions regarding the file of a 
    specified directory tree, suitable for exploring large directories.
* file_permission_reporting_strategy: containing some interchangeable strategies for 
    identifying files with unusual permission settings, modeled through the so-called 
    "Strategy" OO design pattern.
* file_permissions: containing the definition of the class representing the abstraction 
    of file permission.
