...
from fs_analyzer.tests.utils import DirectoryTreeScenario, get_category, get_size, get_unusual_permissions
...
def test_permissions_report_all_unusual_permissions():
    ...
    generated_files_permissions = list(yield_unusual_permissions(directory_path = directory_tree.test_path(), 
