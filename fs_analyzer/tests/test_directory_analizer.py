...
directory_analizer_factory = ExtensionDirectoryAnalizerFactory()
directory_analizer = directory_analizer_factory.create(directory_path = directory_tree.test_path(),
...
def test_handle_provided_directory_not_found_gracefully():
    mock = MagicMock()
    not_existing_directory_analizer = directory_analizer_factory.create(directory_path = directory_tree.test_path() + "jsj", 
                                                                        directory_observer = mock) 
    try:  
        not_existing_directory_analizer.categorize_files()
